...
BEGIN TRY
  ...
  ============================================================================*/
  IF OBJECT_ID(N'dbo.vw_PO_Line_Active', N'V') IS NOT NULL
    DROP VIEW dbo.vw_PO_Line_Active;
  IF OBJECT_ID(N'dbo.vw_PO_Header_WaitingActive', N'V') IS NOT NULL
    DROP VIEW dbo.vw_PO_Header_WaitingActive;

  /*============================================================================
    2) DROP PROCEDURES (depend on types/tables)
  ============================================================================*/
  IF OBJECT_ID(N'dbo.PO_IngestAndBuild', N'P') IS NOT NULL
    DROP PROCEDURE dbo.PO_IngestAndBuild;

  IF OBJECT_ID(N'dbo.PO_BuildApprovalStages', N'P') IS NOT NULL
    DROP PROCEDURE dbo.PO_BuildApprovalStages;

  IF OBJECT_ID(N'dbo.PO_Merge', N'P') IS NOT NULL
    DROP PROCEDURE dbo.PO_Merge;

  IF OBJECT_ID(N'dbo.PO_Staging_Truncate', N'P') IS NOT NULL
    DROP PROCEDURE dbo.PO_Staging_Truncate;

  IF OBJECT_ID(N'dbo.PO_DoA_Direct_Replace', N'P') IS NOT NULL
    DROP PROCEDURE dbo.PO_DoA_Direct_Replace;

  IF OBJECT_ID(N'dbo.PO_DoA_Indirect_Replace', N'P') IS NOT NULL
    DROP PROCEDURE dbo.PO_DoA_Indirect_Replace;

  /*============================================================================
    3) DROP FOREIGN KEYS (so tables can be dropped)
  ============================================================================*/
  IF EXISTS (SELECT 1 FROM sys.foreign_keys WHERE name = N'FK_PO_ApprovalStage_Chain')
    ALTER TABLE dbo.PO_ApprovalStage DROP CONSTRAINT FK_PO_ApprovalStage_Chain;

  IF EXISTS (SELECT 1 FROM sys.foreign_keys WHERE name = N'FK_PO_Line_Header_PoHeaderId')
    ALTER TABLE dbo.PO_Line DROP CONSTRAINT FK_PO_Line_Header_PoHeaderId;

  /*============================================================================
    4) DROP TABLES (children -> parents)
  ============================================================================*/
  IF OBJECT_ID(N'dbo.PO_ApprovalOutbox', N'U') IS NOT NULL
    DROP TABLE dbo.PO_ApprovalOutbox;

  IF OBJECT_ID(N'dbo.PO_Approval_Audit', N'U') IS NOT NULL
    DROP TABLE dbo.PO_Approval_Audit;

  IF OBJECT_ID(N'dbo.PO_ApprovalStage', N'U') IS NOT NULL
    DROP TABLE dbo.PO_ApprovalStage;

  IF OBJECT_ID(N'dbo.PO_ApprovalChain', N'U') IS NOT NULL
    DROP TABLE dbo.PO_ApprovalChain;

  IF OBJECT_ID(N'dbo.PO_Line', N'U') IS NOT NULL
    DROP TABLE dbo.PO_Line;

  IF OBJECT_ID(N'dbo.PO_Header', N'U') IS NOT NULL
    DROP TABLE dbo.PO_Header;

  IF OBJECT_ID(N'dbo.PO_ApproverDirectory', N'U') IS NOT NULL
    DROP TABLE dbo.PO_ApproverDirectory;

  IF OBJECT_ID(N'dbo.PO_DelegationOfAuthority_Direct_Material', N'U') IS NOT NULL
    DROP TABLE dbo.PO_DelegationOfAuthority_Direct_Material;

  IF OBJECT_ID(N'dbo.PO_DelegationOfAuthority_Indirect_Expense', N'U') IS NOT NULL
    DROP TABLE dbo.PO_DelegationOfAuthority_Indirect_Expense;

  IF OBJECT_ID(N'dbo.PO_ApprovalPolicy', N'U') IS NOT NULL
    DROP TABLE dbo.PO_ApprovalPolicy;

  IF OBJECT_ID(N'dbo.PO_Stg_Line', N'U') IS NOT NULL
    DROP TABLE dbo.PO_Stg_Line;

  IF OBJECT_ID(N'dbo.PO_Stg_Header', N'U') IS NOT NULL
    DROP TABLE dbo.PO_Stg_Header;

  /*============================================================================
    5) DROP TYPES (after procs/tables)
  ============================================================================*/
  IF TYPE_ID(N'dbo.PoNumberList') IS NOT NULL
    DROP TYPE dbo.PoNumberList;

  IF TYPE_ID(N'dbo.DoA_DirectType') IS NOT NULL
    DROP TYPE dbo.DoA_DirectType;

  IF TYPE_ID(N'dbo.DoA_IndirectType') IS NOT NULL
    DROP TYPE dbo.DoA_IndirectType;
...
(
  ...
  -- Optional routing scopes (kept for future; nullable; NO DEFAULTS)
  HouseCode     nvarchar(10)  NULL,
  BuyerCode     nvarchar(10)  NULL,
  ...
  CONSTRAINT CK_PO_ApproverDirectory_CostCenterKey CHECK (CostCenterKey IS NULL OR LEN(CostCenterKey) = 6)
);
GO
  ...
  BEGIN TRY
    ...
    WHEN MATCHED THEN
      UPDATE SET
         ...
         -- CostCenterKey computed after line merge
    ...
    ;WITH Candidates AS (
      SELECT
        ...
        ROW_NUMBER() OVER (
          ...
          ORDER BY l.LineNumber ASC, l.PoLineId ASC
        ) AS rn
      FROM dbo.PO_Line l
...
BEGIN
  ...
  SELECT K.PoNumber, K.RoleCode, K.Category, K.ThresholdAmt, NULL
  FROM Kept K;
...
BEGIN
  ...
  WHERE NOT EXISTS (SELECT 1 FROM @New N WHERE N.PoNumber = MS.PoNumber);
...
PRINT 'PO approvals full rebuild deployment complete.';
GO
